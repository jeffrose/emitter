...
describe( 'EventEmitter', function(){
    ...
    describe( 'eventEmitter', function(){
        ...
        it( 'should have functions and properties', function(){
            ...
            expect( emitter._events ).to.be.an( 'object' );
            expect( emitter._maxListeners ).to.be.undefined;
        ...
        it( 'should store listeners differently based on the count', function(){
            var noop = function(){};
            
            expect( emitter._events.test ).to.be.undefined;
            
            emitter.on( 'test', noop );
            
            expect( emitter._events.test ).to.equal( noop );
            
            emitter.on( 'test', noop );
            
            expect( emitter._events.test ).to.deep.equal( [ noop, noop ] );
        } );
        ...
        it( 'should limit the number of subscriptions', function(){
            ...
            expect( onWarn ).to.have.been.calledWith( 'test' );
        ...
        it( 'should set the maximum number of subscriptions', function(){
            ...
            expect( emitter._maxListeners ).to.equal( 2 );
