...
Creates an event listener that will be removed once it returns `true`.
```js
...
```js
    ...
    defineEventsProperty( emitter, _events );
}
...
/**
 * @mixin Emitter~Interface
 */
function asEmitterInterface(){
    /**
     * @constant {Definition} Emitter~Interface.at='@@emitter/at'
     */
    this.at            = '@@emitter/at';
    /**
     * @constant {Definition} Emitter~Interface.clear='@@emitter/clear'
     */
    this.clear         = '@@emitter/clear';
    /**
     * @constant {Definition} Emitter~Interface.emit='@@emitter/emit'
     */
    this.emit          = '@@emitter/emit';
    /**
     * @constant {Definition} Emitter~Interface.eventTypes='@@emitter/eventTypes'
     */
    this.eventTypes    = '@@emitter/eventTypes';
    /**
     * @constant {Definition} Emitter~Interface.first='@@emitter/first'
     */
    this.first         = '@@emitter/first';
    /**
     * @constant {Definition} Emitter~Interface.listenerCount='@@emitter/listenerCount'
     */
    this.listenerCount = '@@emitter/listenerCount';
    /**
     * @constant {Definition} Emitter~Interface.listeners='@@emitter/listeners'
     */
    this.listeners     = '@@emitter/listeners';
    /**
     * @constant {Definition} Emitter~Interface.many='@@emitter/many'
     */
    this.many          = '@@emitter/many';
    /**
     * @constant {Definition} Emitter~Interface.on='@@emitter/on'
     */
    this.on            = '@@emitter/on';
    /**
     * @constant {Definition} Emitter~Interface.once='@@emitter/once'
     */
    this.once          = '@@emitter/once';
    /**
     * @constant {Definition} Emitter~Interface.off='@@emitter/off'
     */
    this.off           = '@@emitter/off';
    /**
     * @constant {Definition} Emitter~Interface.tick='@@emitter/tick'
     */
    this.tick          = '@@emitter/tick';
    /**
     * @constant {Definition} Emitter~Interface.trigger='@@emitter/trigger'
     */
    this.trigger       = '@@emitter/trigger';
    /**
     * @constant {Definition} Emitter~Interface.until='@@emitter/until'
     */
    this.until         = '@@emitter/until';
}

/**
 * @mixin Emitter~Protocol
 */
function asEmitterProtocol(){
     ...
     * @function Emitter~Protocol.@@emitter/at
     * @param {EventType} [type] The event type.
     ...
     */
    this[ '@@emitter/at' ] = function( type, index, listener ){
```
...
```js
     ...
     * @function Emitter~Protocol.@@emitter/clear
     ...
     * // Hi!
     */
    this[ '@@emitter/clear' ] = function( type ){
        let handler;
...
```js
        if( !this[ $events ][ ':off' ] ){
            if( arguments.length === 0 ){
                defineEventsProperty( this, new Null() );
...
```js
     ...
     * @function Emitter~Protocol.@@emitter/emit
     * @param {EventType} type The event type.
     ...
     * // Jeff was greeted.
     */
    this[ '@@emitter/emit' ] = function( type, ...data ){
        return emitAllEvents( this, type, data );
    };
    
    /**
     * @function Emitter~Protocol.@@emitter/eventTypes
     ...
     * // [ 'hello', 'hi' ]
     */ 
    this[ '@@emitter/eventTypes' ] = function(){
        return getEventTypes( this );
    };
    
    /**
     * @function Emitter~Protocol.@@emitter/first
     * @param {EventType} type The event type.
     * @param {EventListener} listener The event callback.
     * @returns {Emitter} The emitter.
     */
    this[ '@@emitter/first' ] = function( type, listener ){
```
Shift arguments if type is not provided
```js
    ...
    /**
     * @function Emitter~Protocol.@@emitter/getMaxListeners
     */
    this[ '@@emitter/getMaxListeners' ] = function(){
        return getMaxListeners( this );
    };
    
    /**
     * @function Emitter~Protocol.@@emitter/listenerCount
     * @param {EventType} type The event type.
     ...
     * // 0
     */ 
    this[ '@@emitter/listenerCount' ] = function( type ){
        let count;
...
```js
    ...
    /**
     * @function Emitter~Protocol.@@emitter/listeners
     * @param {EventType} type The event type.
     * @returns {external:number} The number of listeners for that event type within the given emitter.
     * @example
     ...
     * // true
     */ 
    this[ '@@emitter/listeners' ] = function( type ){
        let listeners;
     ...
     * No checks are made to see if the `listener` has already been added. Multiple calls passing the same combination `type` and `listener` will result in the `listener` being added multiple times.
     * @function Emitter~Protocol.@@emitter/many
     * @param {EventType} type The event type.
     * @param {external:number} times The number times the listener will be executed before being removed.
     * @param {EventListener} listener The event callback.
     * @returns {Emitter} The emitter.
     ...
     */ 
    this[ '@@emitter/many' ] = function( type = $every, times, listener ){
```
Shift arguments if type is not provided
```js
     ...
     * @function Emitter~Protocol.@@emitter/off
     * @param {EventType} type The event type.
     * @param {EventListener} listener The event callback.
     * @returns {Emitter} The emitter.
     * @fires Emitter#:off
     ...
     * greeter.emit( 'hello', 'Jeff' );
     */ 
    this[ '@@emitter/off' ] = function( type = $every, listener ){
```
Shift arguments if type is not provided
```js
        if( typeof type === 'function' && typeof listener === 'undefined' ){
     ...
     * 
     * No checks are made to see if the `listener` has already been added. Multiple calls passing the same combination `type` and `listener` will result in the `listener` being added multiple times.
     * @function Emitter~Protocol.@@emitter/on
     * @param {EventType} [type] The event type.
     * @param {EventListener} listener The event callback.
     * @returns {Emitter} The emitter.
     * @fires Emitter#:on
...
```js
    ...
    /**
     * @function Emitter~Protocol.@@emitter/once
     * @param {EventType} [type] The event type.
     * @param {EventListener} listener The event callback.
     * @returns {Emitter} The emitter.
     * @fires Emitter#:on
     ...
     * greeter.emit( 'hello', 'World' );
     */
    this[ '@@emitter/once' ] = function( type = $every, listener ){
```
Shift arguments if type is not provided
```js
        if( typeof type === 'function' && typeof listener === 'undefined' ){
    ...
    /**
     * @function Emitter~Protocol.@@emitter/setMaxListeners
     */
    this[ '@@emitter/setMaxListeners' ] = function( max ){
     ...
     * 
     * Returns a Promise.
     * @function Emitter~Protocol.@@emitter/tick
     * @param {EventType} type The event type.
     * @param {...*} [data] The data passed into the listeners.
     ...
     * // goodbye heard? false
     */
    this[ '@@emitter/tick' ] = function( type, ...data ){
        const emitter = this;
     ...
     * 
     * Returns `true` if the event had listeners, `false` otherwise.
     * @function Emitter~Protocol.@@emitter/trigger
     * @param {EventType} [type] The event type.
     ...
     * // Jeff was greeted.
     */
    this[ '@@emitter/trigger' ] = function( type, data = [] ){
        return emitAllEvents( this, type, data );
    };
     ...
     * 
     * No checks are made to see if the `listener` has already been added. Multiple calls passing the same combination `type` and `listener` will result in the `listener` being added multiple times.
     * @function Emitter~Protocol.@@emitter/until
     * @param {EventType} [type] The event type.
     * @param {EventListener} listener The event callback.
     * @returns {Emitter} The emitter.
     * @example
     ...
     */
    this[ '@@emitter/until' ] = function( type = $every, listener ){
```
Shift arguments if type is not provided
```js
        if( typeof type === 'function' && typeof listener === 'undefined' ){
...
function defineEventsProperty( emitter, value ){
    if( !hasOwnProperty.call( emitter, $events ) || emitter[ $events ] === Object.getPrototypeOf( emitter )[ $events ] ){
...
/**
 * @function Emitter~defineMaxListenersProperty
 * @param {Emitter} emitter The emitter on which the property will be created.
 */ 
function defineMaxListenersProperty( emitter, value ){
    if( !hasOwnProperty.call( emitter, $maxListeners ) || emitter[ $maxListeners ] === Object.getPrototypeOf( emitter )[ $maxListeners ] ){
...
function getMaxListeners( emitter ){
    defineMaxListenersProperty( emitter, null );
...
asEmitterInterface.call( api );
asEmitterProtocol.call( protocols );
...
```js
        ...
        let API = arguments[ 0 ],
            ...
            index, key, method, methods;
        
```
Shift arguments if API is not provided
```js
...
```
Set target to an empty object if not provided
```js
        if( typeof target === 'undefined' ){
            target = new Null();
        }
        ...
        while( index-- ){
            ...
            if( typeof value === 'string' && key.indexOf( '@@emitter/' ) === 0 && key in protocols ){
                target[ method ] = protocols[ key ];
            }
        }
        
        if( hasOwnProperty.call( target, 'maxListeners' ) ){
            setMaxListeners( target, target.maxListeners );
            delete target.maxListeners;
        }
        
        Object.defineProperty( target, 'maxListeners', {
            get: function(){
                return getMaxListeners( this );
            },
            set: function( max ){
...
asEmitterInterface.call( Emitter.prototype );
...
```
------------------------
Generated _Tue Aug 23 2016 15:27:47 GMT+0000 (UTC)_ from [&#x24C8; emitter.js](emitter.js "View in source")
